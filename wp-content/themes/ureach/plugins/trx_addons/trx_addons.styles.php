...
if (!function_exists('ureach_trx_addons_get_css')) {
	add_filter('ureach_filter_get_css', 'ureach_trx_addons_get_css', 10, 4);
	function ureach_trx_addons_get_css($css, $colors, $fonts, $scheme='') {
...
.top_panel_default .sc_layouts_title_breadcrumbs a,
.top_panel_default .sc_layouts_title_breadcrumbs span {
	color: {$colors['bg_color']} !important;
}
.sc_layouts_title_breadcrumbs a:hover {
	color: {$colors['text_light']} !important;
}
.top_panel_default .post_meta_item.post_counters_item.post_counters_views,
 .top_panel_default .post_meta_item.post_counters_item.post_counters_likes,
  .top_panel_default .post_meta_item.post_counters_item.post_counters_comments {
...
.trx_addons_list_success_circled, .trx_addons_list_success_circled a {
   color: {$colors['text_dark']};
}
...
/*Recent Comments*/
ul#recentcomments, ul#recentcomments .comment-author-link a {
	color: {$colors['text_link']};
}
ul#recentcomments .comment-author-link:hover {
	color: {$colors['text_hover']};
}
...
.sc_price:hover .sc_price_info .sc_price_price {
    color:{$colors['text_link']};
}
...
.scheme_self.footer_wrap .socials_wrap .social_item .social_icon {
	color: {$colors['text_link3']};
	background-color: {$colors['text_hover3_01']};
}
