	...
	?><div class="sc_price_info"><?php
		...
		if (!empty($args['price'])) {
			...
			?><div class="sc_price_price"><?php
				...
				?><span class="sc_price_value"><?php echo wp_kses($parts[0], 'ureach_kses_content'); ?></span><?php
				if (count($parts) > 1 && $parts[1]!='') {
					?><span class="sc_price_decimals"><?php echo wp_kses($parts[1], 'ureach_kses_content'); ?></span><?php
				}
			?></div><?php
		}
		if (!empty($args['description'])) {
			?><div class="sc_price_description"><?php echo wp_kses(trx_addons_parse_codes($args['description']), 'ureach_kses_content'); ?></div><?php
		}
