...
$privacy = ureach_get_privacy_text();
	...
	<form class="sc_form_form <?php if ($form_style != 'default') echo 'sc_input_hover_'.esc_attr($form_style); ?>" method="post" action="<?php echo admin_url('admin-ajax.php'); ?>">
			...
			?><div class="<?php echo esc_attr(trx_addons_get_column_class(1, 2)); ?>"><?php
				trx_addons_get_template_part('shortcodes/form/tpl.form-field.php',
												...
												array_merge($args, array(
																...
																'field_placeholder' => esc_html__('Name', 'ureach')
																))
											);
				?>
				...
				trx_addons_get_template_part('shortcodes/form/tpl.form-field.php',
												...
												array_merge($args, array(
																...
																'field_placeholder' => esc_html__('Email', 'ureach')
																))
											);
				?>
			</div><?php
		...
		trx_addons_get_template_part('shortcodes/form/tpl.form-field.php',
										...
										array_merge($args, array(
														...
														'field_title' => esc_html__('Message', 'ureach'),
														'field_placeholder' => esc_html__('Message', 'ureach')
														))
									);
		if (!empty($privacy)) {
		...
		?>
		<div class="sc_form_field sc_form_field_button"><button><?php esc_html_e('Send Message', 'ureach'); ?></button></div>
