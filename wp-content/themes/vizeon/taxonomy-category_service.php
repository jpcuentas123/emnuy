 ...
 */
   ...
   $sidebar_layout_config = vizeon_get_option('archive_service_sidebar', 'right-sidebar'); 
   $left_sidebar = vizeon_get_option('archive_service_left_sidebar', 'service_sidebar');
   $right_sidebar = vizeon_get_option('archive_service_right_sidebar', 'service_sidebar');
   ...
   $columns_lg = vizeon_get_option('service_columns_lg', '4');
   $columns_md = vizeon_get_option('service_columns_md', '3');
   $columns_sm = vizeon_get_option('service_columns_sm', '2');
   $columns_xs = vizeon_get_option('service_columns_xs', '1');
